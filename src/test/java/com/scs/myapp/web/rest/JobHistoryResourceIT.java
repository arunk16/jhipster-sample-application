...
import com.scs.myapp.JobcandidatesApp;
import com.scs.myapp.domain.JobHistory;
import com.scs.myapp.repository.JobHistoryRepository;
...
import com.scs.myapp.domain.enumeration.Language;
/**
 * Integration tests for the {@link JobHistoryResource} REST controller.
 */
@SpringBootTest(classes = JobcandidatesApp.class)
