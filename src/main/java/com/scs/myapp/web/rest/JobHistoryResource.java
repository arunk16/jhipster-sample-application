...
import com.scs.myapp.domain.JobHistory;
import com.scs.myapp.service.JobHistoryService;
...
/**
 * REST controller for managing {@link com.scs.myapp.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
public class JobHistoryResource {
    ...
    private static final String ENTITY_NAME = "jobcandidatesJobHistory";
