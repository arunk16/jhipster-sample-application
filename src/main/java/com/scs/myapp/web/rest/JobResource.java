...
import com.scs.myapp.domain.Job;
import com.scs.myapp.repository.JobRepository;
...
/**
 * REST controller for managing {@link com.scs.myapp.domain.Job}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class JobResource {
    ...
    private static final String ENTITY_NAME = "jobcandidatesJob";
